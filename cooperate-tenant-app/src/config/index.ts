export const config = {
    backendUrl: import.meta.env.VITE_BACKEND_URL || 'http://localhost:5001/api/v1',
    ...
    backendLiveUrl: import.meta.env.VITE_BACKEND_LIVE_URL || 'https://cooperative-tenant-1.onrender.com/api/v1',

    advanced_key: import.meta.env.VITE_ADVANCED_KEY || 'ueiweuwewiewoieuoweuwoieuweoiuwueio',
    advanced_iv: import.meta.env.VITE_ADVANCED_IV || 'ueiweuwewiewoieuoweuwoieuweoiuwueio',
